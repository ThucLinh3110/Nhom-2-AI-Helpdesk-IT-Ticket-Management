# Test Strategy — theo yêu cầu Nhóm trưởng
...
## Bảng Layer / Coverage (theo đúng mẫu chuẩn)
...
## Story được coi là "Test xong" khi
- [ ] Toàn bộ case trong AC đã test, có Pass/Fail.
- [ ] Không còn lỗi Critical/Blocker.
- [ ] Đã cập nhật `traceability.xlsx`.
