...
| :--- | :--- | :--- | :--- | :--- |
| **REQ-HD-01** | FR | Khách hàng có thể tạo vé (Ticket) báo cáo sự cố bằng văn bản và đính kèm hình ảnh. | User Research | Must |
...
| **REQ-HD-06** | FR | IT Manager có thể phân công (assign) vé thủ công cho một IT Agent cụ thể. | Persona: Manager | Must |
...
| **NFR-HD-03** | NFR | Các endpoint API gọi AI phải được phân quyền (Auth) và bảo mật, không rò rỉ API Key ở frontend. | Constraint | Must |
| **NFR-HD-04** | NFR | Hệ thống phải lưu log (lịch sử) mỗi khi trạng thái vé hoặc người phụ trách bị thay đổi. | NFR tiêu chuẩn | Must |
